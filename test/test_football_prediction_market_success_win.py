...
def test_football_prediction_market_success():
    ...
    assert get_prediction_result == {
        account_1.address: test_football_prediction_market_predictions_win_unresolved
    }
    ...
    assert get_prediction_result == {
        account_1.address: test_football_prediction_market_predictions_win_resolved
    }
