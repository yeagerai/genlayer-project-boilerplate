...
from test.football_bets_get_contract_schema_for_code import (
    ...
    test_football_bets_bets_unsuccess_unresolved,
    test_football_bets_bets_unsuccess_resolved,
)
...
def test_football_bets_unsuccess():
    ...
    assert get_bet_result == {
        account_1.address: test_football_bets_bets_unsuccess_unresolved
    }
    ...
    get_bet_result = call_contract_method(contract_address, account_1, "get_bets", [])
    assert get_bet_result == {
        account_1.address: test_football_bets_bets_unsuccess_resolved
    }
